                    ...
                    <div class="header-nav-section">
                        <div class="container">
                            <ul class="nav menu-nav clone-main-menu" id="mercado_haead_menu" data-menuname="Sale Info">
                                <li class="menu-item"><a href="#" class="link-term">Featured Items</a></li>
                                <li class="menu-item"><a href="#" class="link-term">Sale items</a></li>
                                <li class="menu-item"><a href="#" class="link-term">new items</a></li>
                                <li class="menu-item"><a href="#" class="link-term">Top Selling</a></li>
                                <li class="menu-item"><a href="#" class="link-term">Auction</a></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="wrap-contact-detail">
                                        <ul>
                                            <li>
                                                ...
                                                <p class="contact-txt">10/A Pettah Road, Colombo 01, Sri Lanka</p>
                                            </li>
                                            <li>
                                                <i class="fa fa-phone" aria-hidden="true"></i>
                                                <p class="contact-txt">(+94)11 189 7541 </p>
                                            </li>
                                            <li>
                                                <i class="fa fa-envelope" aria-hidden="true"></i>
                                                <p class="contact-txt">Info@cosmo.com</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="wrap-footer-item">
                                ...
                                <div class="item-content">
                                    <div class="wrap-hotline-footer">
                                        ...
                                        <b class="phone-number">(+94)11 189 7541</b> --}}
                                    </div>
                                </div>
                            </div>
            ...
            <div class="coppy-right-box">
                <div class="container">
                    <div class="coppy-right-item item-left">
                        <p class="coppy-right-text">Copyright © 2022 Cosmo. All rights reserved</p>
                    </div>
